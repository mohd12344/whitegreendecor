...
export default function WhyChooseUs() {
  return (
    <section className="overflow-hidden py-9 flex flex-col gap-10">
      ...
      <div className="bg-stone-50 border border-amber-100 rounded-2xl flex flex-col lg:flex-row gap-5 lg:gap-0 sm:py-7 my-1.5 sm:my-3 sm:px-6">
        {/* Left Content */}
        <div className="bg-[#0d2818] rounded-xl lg:rounded-l-xl px-5 py-6 flex flex-col gap-3 lg:w-75 shrink-0">
